    ...
    return [
        Tool(
            ...
            description=(
                ...
                "【重要定義：用語の取り違え厳禁】\n"
                "1. total_work_time (実働時間): 届出(notification_am / notification_pm)が、「遅刻・早退・欠勤」を除いた有休等の時間を含む値。\n"
                ...
                PromptMessage(
                    ...
                    content=TextContent(
                        ...
                        text=(
                            ...
                            "会社特有の用語として、total_work_time → '実働時間'、actual_site_time → 'リアル実働時間'と置き換えてください。\n"
                            "【重要】その他のJSONスキーマのキー名('records'キーのリスト内も含む)は、システム管理者としての用語であり使用は禁止とします。回答の際は、これらを必ず日本語に置き換えてください。\n"
